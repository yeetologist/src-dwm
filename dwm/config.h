...
static char normbordercolor[]       = "#444";
static char normfgcolor[]           = "#bbb";
static char selfgcolor[]            = "#eee";
static char selbordercolor[]        = "#fff";
...
static Key keys[] = {
	...
	{ MODKEY,			XK_grave,	spawn,	SHCMD(TERMINAL " -e newsboat; pkill -RTMIN+6 dwmblocks") },
	...
	{ MODKEY|ShiftMask,		XK_c,		spawn,		SHCMD("xdotool type $(cat ~/.local/share/larbs/snippets | dmenu -i -l 50 | cut -d' ' -f1)") },
